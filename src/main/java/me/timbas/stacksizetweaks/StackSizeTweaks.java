...
import me.timbas.stacksizetweaks.InventoryTweaksConfig;

public class StackSizeTweaks implements ModInitializer {

    public static final int MAX_STACK_SIZE = Integer.MAX_VALUE;
    public static final String MOD_ID = "assets/stacksizetweaks";
    ...
    public void onInitialize() {
        LOGGER.info("Initialized Inventory Tweaks!");
    }
